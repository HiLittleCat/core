...
func (n *node) addRoute(path string, handlers RouterHandlerChain) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path string, fullPath string, handlers RouterHandlerChain) {
